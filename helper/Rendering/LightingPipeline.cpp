...
void LightingPipeline::createLightingPipeline(VkDevice device,
    ...
    // Load shaders
    auto vertCode = readFile("shaders/deferred_lighting.vert.spv");
    auto fragCode = readFile("shaders/deferred_lighting.frag.spv");
    ...
    // Depth stencil (no depth test in lighting pass)
    ...
    pipelineInfo.subpass = 1;  // Lighting is subpass 1
